...
test("validate-more digit", function() {
...
test("validate-more url", function() {
...
test("validate-more email", function() {
...
test("validate-more number", function() {
...
test("validate-more date", function() {
...
test("validate-more dateISO", function() {
...
test("validate-more minlength", function() {
...
test("validate-more maxlength", function() {
	var v = jQuery("#form").validate();
...
test("validate-more rangelength", function() {
	var v = jQuery("#form").validate();
...
test("validate-more min", function() {
	var v = jQuery("#form").validate();
...
test("validate-more max", function() {
	var v = jQuery("#form").validate();
...
test("validate-more range", function() {
	var v = jQuery("#form").validate();
...
test("validate-more equalTo", function() {
	var v = jQuery("#form").validate();
...
test("validate-more remote", function() {
	expect(7);
	stop();
	var e = $("#username");
...
test("validate-more remote, customized ajax options", function() {
	expect(2);
	stop();
	var v = $("#userForm").validate({
		rules: {
...
test("validate-more remote extensions", function() {
	expect(5);
	stop();
	var e = $("#username");
	var v = $("#userForm").validate({
...
test("validate-more phone (us)", function() {
...
test("validate-more dateITA", function() {
...
test("validate-more time", function() {
...
test("validate-more minWords", function() {
...
test("validate-more maxWords", function() {
